...
## 2 帕累托原理
该原则也被称为`80/20 规则`、`关键少数法则`或`因子稀疏原则`。[约瑟夫·朱兰 (Joseph Juran)](/项目管理/名人堂/朱兰)于 1937 年公布了这个概念，并以著名经济学家维尔弗雷多·帕累托的名字命名，他在 19 世纪后期首次记录了这种现象。
